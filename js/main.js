...
/*var weekFn(n) = Status;
switch (weekFn(n)) {
  case '1': Status = 'Понедельник';
  case '2': Status = 'Вторник';
  case '3': Status = 'Среда';
  case '4': Status = 'Четверг';
  case '5': Status = 'Пятница';
  case '6': Status = 'Суббота';
  case '7': Status = 'Воскресенье';
  default: Status = 'null';
